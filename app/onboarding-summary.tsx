...
const styles = StyleSheet.create({
  ...
  badge: { color: SF.gold, fontFamily: "Outfit_700Bold", fontSize: 12, letterSpacing: 2, marginBottom: 12 },
  title: { color: SF.fg, fontFamily: "Outfit_800ExtraBold", fontSize: 32, textAlign: "center", lineHeight: 40, marginBottom: 12 },
  ...
  cardTitle: { color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 17, marginBottom: 16 },
  ...
  photoLabel: { color: SF.muted, fontFamily: "Outfit_700Bold", fontSize: 11, letterSpacing: 1.5, marginBottom: 8 },
  ...
  bfBadge: { color: SF.gold, fontFamily: "Outfit_700Bold", fontSize: 13, textAlign: "center", marginTop: 4 },
  statsRow: { flexDirection: "row", justifyContent: "space-around", marginBottom: 16 },
  statBox: { alignItems: "center" },
  statNum: { color: SF.fg, fontFamily: "Outfit_800ExtraBold", fontSize: 26, lineHeight: 32 },
  ...
  dayDotText: { color: SF.muted, fontFamily: "Outfit_700Bold", fontSize: 12 },
  dayCard: { backgroundColor: "#0A0500", borderRadius: 12, padding: 12, marginBottom: 8, borderWidth: 1, borderColor: SF.border },
  dayCardTitle: { color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 13, marginBottom: 4 },
  ...
  mealName: { color: SF.fg, fontFamily: "Outfit_600SemiBold", fontSize: 14 },
  ...
  ctaBtnText: { color: SF.bg, fontFamily: "Outfit_700Bold", fontSize: 17 },
});
