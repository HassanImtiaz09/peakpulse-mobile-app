...
const styles = StyleSheet.create({
  ...
  badge: { color: SF.gold, fontFamily: "Outfit_700Bold", fontSize: 11, letterSpacing: 2, marginBottom: 12 },
  title: { color: SF.fg, fontFamily: "Outfit_800ExtraBold", fontSize: 30, textAlign: "center", lineHeight: 38, marginBottom: 10 },
  ...
  billingBtnText: { color: SF.muted, fontFamily: "Outfit_600SemiBold", fontSize: 14 },
  ...
  saveBadgeText: { color: "#fff", fontFamily: "Outfit_700Bold", fontSize: 10 },
  ...
  planName: { color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 18, marginBottom: 4 },
  planPrice: { color: SF.fg, fontFamily: "Outfit_800ExtraBold", fontSize: 28, lineHeight: 34 },
  ...
  selectedBannerText: { color: SF.gold, fontFamily: "Outfit_700Bold", fontSize: 13 },
  ...
  popularBadgeText: { color: SF.bg, fontFamily: "Outfit_700Bold", fontSize: 11, letterSpacing: 1 },
