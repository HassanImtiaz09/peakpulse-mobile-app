  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#0A0500" }}>
      ...
      <View style={{ width: "100%", height: 160, overflow: "hidden" }}>
        <Animated.View style={[{ position: "absolute", top: 0, left: 0, right: 0, height: 260 }, heroImageStyle]}>
              ...
              <View>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center", gap: 8 }}>
                    ...
                    >
                      <MaterialIcons name="picture-as-pdf" size={12} color="#FBBF24" />
                ...
                {workoutPlan.insight && (
                  <View style={{ backgroundColor: "#7C3AED10", borderRadius: 12, padding: 12, marginBottom: 12, borderWidth: 1, borderColor: "rgba(245,158,11,0.12)" }}>
                    <View style={{ flexDirection: "row", gap: 8, alignItems: "flex-start" }}>
                      ...
                      <Text style={{ color: "#FBBF24", fontSize: 13, lineHeight: 18, flex: 1 }}>{String(workoutPlan.insight)}</Text>
                    </View>
                  </View>
                )}
                ...
                {mealPlan.insight && (
                  <View style={{ backgroundColor: "#22C55E10", borderRadius: 12, padding: 12, marginBottom: 16, borderWidth: 1, borderColor: "#22C55E30" }}>
                    <View style={{ flexDirection: "row", gap: 8, alignItems: "flex-start" }}>
                      ...
                      <Text style={{ color: "#FBBF24", fontSize: 13, lineHeight: 18, flex: 1 }}>{String(mealPlan.insight)}</Text>
                    </View>
                  </View>
                )}
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start" }}>
          <View style={{ flex: 1 }}>
            ...
            <View style={{ flexDirection: "row", gap: 12, marginTop: 4 }}>
              ...
              {exercise.rest && <View style={{ flexDirection: "row", alignItems: "center", gap: 2 }}><MaterialIcons name="timer" size={11} color="#92400E" /><Text style={{ color: "#92400E", fontSize: 12 }}>{exercise.rest}</Text></View>}</View>
