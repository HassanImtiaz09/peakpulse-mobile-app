...
const styles = StyleSheet.create({
  ...
  heroLabel: { color: "#a78bfa", fontSize: 11, fontFamily: "Syne_700Bold", letterSpacing: 2, marginBottom: 4 },
  heroTitle: { color: "#fff", fontSize: 28, fontFamily: "Syne_800ExtraBold", marginBottom: 4 },
  ...
  tabText: { color: "#6b7280", fontSize: 14, fontFamily: "Inter_600SemiBold" },
  ...
  shareBarBtnText: { color: "#fff", fontSize: 15, fontFamily: "Syne_700Bold" },
  ...
  postUserName: { color: "#fff", fontSize: 14, fontFamily: "Syne_700Bold" },
  ...
  typeBadgeText: { color: "#fff", fontSize: 10, fontFamily: "Syne_700Bold" },
  postImage: { width: "100%", height: 220 },
  achievementBanner: { backgroundColor: "#451a03", padding: 12, margin: 14, borderRadius: 10 },
  achievementText: { color: "#fbbf24", fontSize: 15, fontFamily: "Syne_700Bold", textAlign: "center" },
  ...
  statChipValue: { color: "#a78bfa", fontSize: 16, fontFamily: "Syne_700Bold" },
  ...
  emptyTitle: { color: "#fff", fontSize: 20, fontFamily: "Syne_700Bold", marginBottom: 8 },
  emptyText: { color: "#6b7280", fontSize: 14, textAlign: "center" },
  challengesTitle: { color: "#fff", fontSize: 22, fontFamily: "Syne_800ExtraBold", marginBottom: 4 },
  ...
  createChallengeBtnText: { color: "#fff", fontSize: 14, fontFamily: "Syne_700Bold" },
  ...
  modalTitle: { color: "#fff", fontSize: 17, fontFamily: "Syne_700Bold" },
  modalPost: { color: "#7c3aed", fontSize: 16, fontFamily: "Syne_700Bold" },
  modalBody: { flex: 1, padding: 16 },
  modalLabel: { color: "#9ca3af", fontSize: 13, fontFamily: "Inter_600SemiBold", marginBottom: 8, marginTop: 16 },
  postTypeRow: { flexDirection: "row", gap: 8 },
  postTypeBtn: { flex: 1, backgroundColor: "#1f2937", borderRadius: 10, paddingVertical: 10, alignItems: "center", borderWidth: 1, borderColor: "rgba(226,232,240,0.12)" },
  postTypeBtnActive: { backgroundColor: "#2d1b69", borderColor: "#7c3aed" },
  postTypeBtnText: { color: "#9ca3af", fontSize: 12, fontFamily: "Inter_600SemiBold" },
  postTypeBtnTextActive: { color: "#c4b5fd" },
  captionInput: { backgroundColor: "#1f2937", borderRadius: 12, padding: 14, color: "#fff", fontSize: 14, lineHeight: 22, minHeight: 100, textAlignVertical: "top", borderWidth: 1, borderColor: "rgba(226,232,240,0.12)" },
  statsInputRow: { flexDirection: "row", gap: 12 },
  statsInputGroup: { flex: 1 },
  statsInputLabel: { color: "#6b7280", fontSize: 12, marginBottom: 6 },
  statsInput: { backgroundColor: "#1f2937", borderRadius: 10, padding: 12, color: "#fff", fontSize: 14, borderWidth: 1, borderColor: "rgba(226,232,240,0.12)" },
  photoPickerBtn: { backgroundColor: "#1f2937", borderRadius: 12, height: 120, alignItems: "center", justifyContent: "center", borderWidth: 1, borderColor: "rgba(226,232,240,0.12)", borderStyle: "dashed", overflow: "hidden" },
