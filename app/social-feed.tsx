...
const styles = StyleSheet.create({
  ...
  heroLabel: { color: "#a78bfa", fontSize: 11, fontFamily: "DMSans_700Bold", letterSpacing: 2, marginBottom: 4 },
  heroTitle: { color: "#fff", fontSize: 28, fontFamily: "BebasNeue_400Regular", marginBottom: 4 },
  ...
  shareBarBtnText: { color: "#fff", fontSize: 15, fontFamily: "DMSans_700Bold" },
  ...
  postUserName: { color: "#fff", fontSize: 14, fontFamily: "DMSans_700Bold" },
  ...
  typeBadgeText: { color: "#fff", fontSize: 10, fontFamily: "DMSans_700Bold" },
  postImage: { width: "100%", height: 220 },
  achievementBanner: { backgroundColor: "#451a03", padding: 12, margin: 14, borderRadius: 10 },
  achievementText: { color: "#fbbf24", fontSize: 15, fontFamily: "DMSans_700Bold", textAlign: "center" },
  ...
  statChipValue: { color: "#a78bfa", fontSize: 16, fontFamily: "DMSans_700Bold" },
  ...
  emptyTitle: { color: "#fff", fontSize: 20, fontFamily: "DMSans_700Bold", marginBottom: 8 },
  emptyText: { color: "#6b7280", fontSize: 14, textAlign: "center" },
  challengesTitle: { color: "#fff", fontSize: 22, fontFamily: "BebasNeue_400Regular", marginBottom: 4 },
  ...
  createChallengeBtnText: { color: "#fff", fontSize: 14, fontFamily: "DMSans_700Bold" },
  ...
  modalTitle: { color: "#fff", fontSize: 17, fontFamily: "DMSans_700Bold" },
  modalPost: { color: "#7c3aed", fontSize: 16, fontFamily: "DMSans_700Bold" },
