...
const styles = StyleSheet.create({
  ...
  heroLabel: { color: "#a78bfa", fontSize: 11, fontFamily: "Outfit_700Bold", letterSpacing: 2, marginBottom: 6 },
  heroTitle: { color: "#fff", fontSize: 30, fontFamily: "Outfit_800ExtraBold", lineHeight: 38 },
  ...
  streakCount: { color: "#fbbf24", fontSize: 18, fontFamily: "Outfit_800ExtraBold" },
  ...
  streakBadgeText: { color: "#fbbf24", fontSize: 12, fontFamily: "Outfit_700Bold" },
  milestonesScroll: { marginBottom: 20 },
  milestoneChip: { backgroundColor: "#1f2937", borderRadius: 10, padding: 10, marginRight: 8, alignItems: "center", minWidth: 56, borderWidth: 1, borderColor: "rgba(16,185,129,0.15)" },
  ...
  todayTitle: { color: "#22c55e", fontSize: 16, fontFamily: "Outfit_700Bold" },
  ...
  todayStatValue: { color: "#a78bfa", fontSize: 22, fontFamily: "Outfit_800ExtraBold" },
  ...
  formTitle: { color: "#fff", fontSize: 18, fontFamily: "Outfit_700Bold", marginBottom: 4 },
  ...
  photoPlaceholder: { backgroundColor: "#1f2937", borderRadius: 12, height: 160, alignItems: "center", justifyContent: "center", marginBottom: 10, borderWidth: 1, borderColor: "rgba(16,185,129,0.15)", borderStyle: "dashed" },
  ...
  photoBtn: { flex: 1, backgroundColor: "#1f2937", borderRadius: 10, paddingVertical: 12, alignItems: "center", borderWidth: 1, borderColor: "rgba(16,185,129,0.15)" },
  ...
  analysisTitle: { color: "#60a5fa", fontSize: 15, fontFamily: "Outfit_700Bold", marginBottom: 12 },
  ...
  analysisStatValue: { color: "#a78bfa", fontSize: 20, fontFamily: "Outfit_800ExtraBold" },
  analysisStatLabel: { color: "#6b7280", fontSize: 11, marginTop: 2 },
  tipsSection: { marginTop: 10 },
  tipsTitle: { color: "#fbbf24", fontSize: 13, fontFamily: "Outfit_700Bold", marginBottom: 6 },
  ...
  input: { backgroundColor: "#1f2937", borderRadius: 10, padding: 12, color: "#fff", fontSize: 14, borderWidth: 1, borderColor: "rgba(16,185,129,0.15)" },
  notesInput: { minHeight: 80, textAlignVertical: "top" },
  saveBtn: { backgroundColor: "#7c3aed", borderRadius: 14, paddingVertical: 16, alignItems: "center", marginTop: 20 },
  saveBtnText: { color: "#fff", fontSize: 16, fontFamily: "Outfit_800ExtraBold" },
  historySection: { marginTop: 8 },
  historyTitle: { color: "#fff", fontSize: 18, fontFamily: "Outfit_700Bold", marginBottom: 14 },
  ...
  historyBFValue: { color: "#a78bfa", fontSize: 16, fontFamily: "Outfit_700Bold" },
