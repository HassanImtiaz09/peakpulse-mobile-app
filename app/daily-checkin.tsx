...
const styles = StyleSheet.create({
  ...
  heroLabel: { color: "#a78bfa", fontSize: 11, fontWeight: "700", letterSpacing: 2, marginBottom: 6 },
  heroTitle: { color: "#fff", fontSize: 30, fontWeight: "800", lineHeight: 38 },
  ...
  streakCount: { color: "#fbbf24", fontSize: 18, fontWeight: "800" },
  ...
  streakBadgeText: { color: "#fbbf24", fontSize: 12, fontWeight: "700" },
  milestonesScroll: { marginBottom: 20 },
  milestoneChip: { backgroundColor: "#1f2937", borderRadius: 10, padding: 10, marginRight: 8, alignItems: "center", minWidth: 56, borderWidth: 1, borderColor: "#374151" },
  milestoneChipAchieved: { backgroundColor: "#1a0a00", borderColor: "#92400e" },
  milestoneEmoji: { fontSize: 20, marginBottom: 4 },
  milestoneDays: { color: "#9ca3af", fontSize: 11, fontWeight: "600" },
  ...
  todayTitle: { color: "#22c55e", fontSize: 16, fontWeight: "700" },
  ...
  todayStatValue: { color: "#a78bfa", fontSize: 22, fontWeight: "800" },
  ...
  updateBtnText: { color: "#9ca3af", fontSize: 14, fontWeight: "600" },
  ...
  photoPlaceholder: { backgroundColor: "#1f2937", borderRadius: 12, height: 160, alignItems: "center", justifyContent: "center", marginBottom: 10, borderWidth: 1, borderColor: "#374151", borderStyle: "dashed" },
  photoPlaceholderEmoji: { fontSize: 36, marginBottom: 8 },
  photoPlaceholderText: { color: "#9ca3af", fontSize: 15, fontWeight: "600", marginBottom: 4 },
  photoPlaceholderSub: { color: "#6b7280", fontSize: 12, textAlign: "center", paddingHorizontal: 20 },
  photoButtons: { flexDirection: "row", gap: 10 },
  photoBtn: { flex: 1, backgroundColor: "#1f2937", borderRadius: 10, paddingVertical: 12, alignItems: "center", borderWidth: 1, borderColor: "#374151" },
  photoBtnText: { color: "#e5e7eb", fontSize: 14, fontWeight: "600" },
  analysisCard: { backgroundColor: "#0f172a", borderRadius: 12, padding: 14, marginBottom: 16, borderWidth: 1, borderColor: "#1e3a5f" },
  analysisTitle: { color: "#60a5fa", fontSize: 15, fontWeight: "700", marginBottom: 12 },
  ...
  analysisStatValue: { color: "#a78bfa", fontSize: 20, fontWeight: "800" },
  analysisStatLabel: { color: "#6b7280", fontSize: 11, marginTop: 2 },
  tipsSection: { marginTop: 10 },
  tipsTitle: { color: "#fbbf24", fontSize: 13, fontWeight: "700", marginBottom: 6 },
  ...
  bodyCompLabel: { color: "#9ca3af", fontSize: 12, fontWeight: "600" },
  bodyCompValue: { color: "#e5e7eb", fontSize: 12, flex: 1 },
  inputLabel: { color: "#9ca3af", fontSize: 13, fontWeight: "600", marginBottom: 8, marginTop: 12 },
  input: { backgroundColor: "#1f2937", borderRadius: 10, padding: 12, color: "#fff", fontSize: 14, borderWidth: 1, borderColor: "#374151" },
  notesInput: { minHeight: 80, textAlignVertical: "top" },
  saveBtn: { backgroundColor: "#7c3aed", borderRadius: 14, paddingVertical: 16, alignItems: "center", marginTop: 20 },
  saveBtnText: { color: "#fff", fontSize: 16, fontWeight: "800" },
  historySection: { marginTop: 8 },
  historyTitle: { color: "#fff", fontSize: 18, fontWeight: "700", marginBottom: 14 },
  ...
  historyBFValue: { color: "#a78bfa", fontSize: 16, fontWeight: "700" },
