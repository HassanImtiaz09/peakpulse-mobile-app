                ...
                {data.map((d, i) => {
                  ...
                  return (
                    <View key={d.date} style={{ flexDirection: "row", alignItems: "center", marginBottom: 8 }}>
                      <Text style={{ color: "#92400E", fontSize: 10, fontFamily: "Outfit_700Bold", width: 32 }}>
                        {d.shortLabel}
                      </Text>
                      ...
                      <Text style={{ color: "#92400E", fontSize: 9, fontFamily: "Outfit_700Bold", width: 36, textAlign: "right" }}>
                        {totalG > 0 ? `${totalG}g` : "—"}
                      </Text>
                    </View>
                  );
                  ...
                  <Svg width={180} height={180} viewBox="0 0 180 180">
                    {totalMacroG > 0 ? (
                      (() => {
                        ...
                        return (
                          <>
                            ...
                            <SvgText x={cx} y={cy + 14} textAnchor="middle" fill="#92400E" fontSize={10}>
                              kcal
                            </SvgText>
                          </>
                        );
                      ...
                      <>
                        ...
                        <SvgText x={90} y={90} textAnchor="middle" fill="#92400E" fontSize={12}>
                          No data
                        </SvgText>
                      </>
                    )}
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-around", marginTop: 12 }}>
                  {[
                    ...
                    <View key={m.label} style={{ alignItems: "center" }}>
                      ...
                      <Text style={{ color: "#92400E", fontSize: 10, marginTop: 2 }}>{m.label} ({m.pct}%)</Text>
                    </View>
                  ))}
                </View>
              </View>
              ...
              <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 8, marginTop: 8 }}>
                {[
                  ...
                  <View key={stat.label} style={{ flex: 1, minWidth: "45%", backgroundColor: "rgba(245,158,11,0.06)", borderRadius: 12, padding: 12, borderWidth: 1, borderColor: "rgba(245,158,11,0.08)" }}>
                    ...
                    <Text style={{ color: "#92400E", fontSize: 10, fontFamily: "Outfit_700Bold" }}>{stat.label}</Text>
                  </View>
                ))}
              </View>
            </View>
...
const styles = StyleSheet.create({
  ...
  toggleText: { color: "#92400E", fontSize: 13, fontFamily: "Outfit_700Bold" },
  ...
  chartSubtitle: { color: "#92400E", fontSize: 11, fontFamily: "Outfit_700Bold", marginTop: 2 },
  macroLegend: { flexDirection: "row", gap: 12, marginTop: 8 },
  legendItem: { flexDirection: "row", alignItems: "center", gap: 4 },
  legendDot: { width: 8, height: 8, borderRadius: 4 },
  legendText: { color: "#92400E", fontSize: 10, fontFamily: "Outfit_700Bold" },
});
