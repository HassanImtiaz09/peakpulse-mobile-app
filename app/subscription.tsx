...
const styles = StyleSheet.create({
  ...
  heroLabel: { color: "#a78bfa", fontSize: 12, fontFamily: "Syne_700Bold", letterSpacing: 2, marginBottom: 8 },
  heroTitle: { color: "#fff", fontSize: 32, fontFamily: "Syne_800ExtraBold", lineHeight: 40, marginBottom: 8 },
  ...
  toggleText: { color: "#9ca3af", fontSize: 14, fontFamily: "Inter_600SemiBold" },
  toggleTextActive: { color: "#fff" },
  saveBadge: { backgroundColor: "#22c55e", borderRadius: 6, paddingHorizontal: 6, paddingVertical: 2 },
  saveBadgeText: { color: "#fff", fontSize: 10, fontFamily: "Syne_700Bold" },
  ...
  popularText: { color: "#fff", fontSize: 9, fontFamily: "Syne_800ExtraBold", letterSpacing: 1 },
  planName: { color: "#9ca3af", fontSize: 14, fontFamily: "Syne_700Bold", marginBottom: 8 },
  planNameAdvanced: { color: "#c4b5fd" },
  priceRow: { flexDirection: "row", alignItems: "flex-start" },
  currency: { color: "#fff", fontSize: 18, fontFamily: "Syne_700Bold", marginTop: 6 },
  currencyAdvanced: { color: "#a78bfa" },
  price: { color: "#fff", fontSize: 36, fontFamily: "Syne_800ExtraBold", lineHeight: 44 },
  ...
  selectIndicatorText: { color: "#fff", fontSize: 12, fontFamily: "Inter_600SemiBold" },
  section: { marginBottom: 28 },
  sectionTitle: { color: "#fff", fontSize: 18, fontFamily: "Syne_700Bold", marginBottom: 14 },
  featureRow: { flexDirection: "row", alignItems: "center", paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: "#1a1a2e" },
  featureIcon: { fontSize: 16, fontFamily: "Syne_700Bold", width: 28 },
  ...
  compareHeaderText: { color: "#9ca3af", fontSize: 12, fontFamily: "Syne_700Bold" },
  ...
  compareHighlightText: { color: "#a78bfa", fontFamily: "Syne_700Bold" },
  ...
  ctaBtnText: { color: "#fff", fontSize: 17, fontFamily: "Syne_800ExtraBold" },
  ...
  stripeNoteTitle: { color: "#60a5fa", fontSize: 14, fontFamily: "Syne_700Bold", marginBottom: 8 },
