...
const styles = StyleSheet.create({
  ...
  backText: { color: "#F1F5F9", fontSize: 16 },
  ...
  featureRow: { flexDirection: "row", alignItems: "center", paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: "#141A22" },
  featureIcon: { fontSize: 16, fontFamily: "DMSans_700Bold", width: 28 },
