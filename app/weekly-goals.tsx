      ...
      <ImageBackground source={{ uri: DASHBOARD_BG }} style={{ flex: 1 }} imageStyle={{ opacity: 0.08 }}>
        <ScreenContainer edges={["top", "left", "right"]} className="flex-1">
          ...
          <View style={{
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 20 }}>Weekly Goals</Text>
          ...
          <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
            ...
            <View style={{
              ...
              <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
                ...
                <View>
                  <Text style={{ color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 15 }}>Goal Tracking</Text>
            ...
            <View style={{
              ...
              <View style={{ marginBottom: 18 }}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 8 }}>
                  ...
                  <Text style={{ color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 14 }}>Daily Steps Target</Text>
                </View>
                <TextInput
                  ...
                  style={{
                    ...
                    color: SF.gold3, fontFamily: "Outfit_700Bold", fontSize: 18,
              ...
              <View style={{ marginBottom: 18 }}>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 8 }}>
                  ...
                  <Text style={{ color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 14 }}>Daily Calories Burned Target</Text>
                </View>
                <TextInput
              ...
              <View>
                <View style={{ flexDirection: "row", alignItems: "center", gap: 8, marginBottom: 8 }}>
                  ...
                  <Text style={{ color: SF.fg, fontFamily: "Outfit_700Bold", fontSize: 14 }}>Workouts Per Week</Text>
                </View>
