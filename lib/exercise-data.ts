...
export interface ExerciseAngleView {
  ...
  label: string;
  /** Focus annotation â what to watch for from this angle */
  focus: string;
}
...
// ââ Exercise Database âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
const EXERCISE_DB: ExerciseInfo[] = [
  ...
  },
  {
    ...
    difficulty: "intermediate",
    cue: "30-45Â° incline. Drive bar in a slight arc to upper chest.",
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-incline-bench-press-front.mp4", label: "Front View", focus: "Grip slightly narrower than flat bench, elbows at 45Â° from torso" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-incline-bench-press-side.mp4", label: "Side View", focus: "Bench angle between 30-45Â°, bar touches upper chest just below collarbone" }
      ],
  },
  {
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-weighted-dip-front.mp4", label: "Front View", focus: "Elbows track slightly outward, lower until 90Â° elbow bend" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-weighted-dip-side.mp4", label: "Side View", focus: "Forward lean targets chest, upright targets triceps â lean 30Â° forward" }
      ],
  },
  {
    name: "Chest Dip",
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-bent-over-row-front.mp4", label: "Front View", focus: "Knees slightly bent, back flat â no rounding of lower back" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-bent-over-row-side.mp4", label: "Side View", focus: "Torso at 45Â° angle, bar travels straight up to lower chest/upper abs" }
      ],
  },
  {
    name: "Dumbbell Row",
  ...
  },
  {
    ...
    angleViews: [
        ...
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-landmine-t-bar-rows-side.mp4", label: "Side View", focus: "Torso at 45Â°, pull handle to chest, elbows drive back" }
      ],
  },
  {
    name: "Pendlay Row",
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-pendlay-row-front.mp4", label: "Front View", focus: "Overhand grip slightly wider than shoulder width" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-pendlay-row-side.mp4", label: "Side View", focus: "Back parallel to floor, explosive concentric, controlled return to floor" }
      ],
  },
  ...
  // ââ SHOULDERS ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-overhead-press-front.mp4", label: "Front View", focus: "Bar starts at collarbone, press straight up â head moves back to let bar pass" },
  ...
  },
  {
    ...
    angleViews: [
        ...
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-overhead-press-side.mp4", label: "Side View", focus: "Elbows at 90Â° at bottom, full extension at top" }
      ],
  },
  {
    name: "Lateral Raise",
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-lateral-raise-front.mp4", label: "Front View", focus: "Raise to shoulder height only â going higher shifts to traps" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-front-raise-front.mp4", label: "Front View", focus: "Palms face down or neutral, don't swing â use strict form" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-rear-delt-fly-front.mp4", label: "Front View", focus: "Bent over 45-60Â°, raise arms to shoulder height, squeeze at top" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-arnold-press-front.mp4", label: "Front View", focus: "Start with palms facing chest, rotate 180Â° as you press overhead" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-shrug-front.mp4", label: "Front View", focus: "Straight up and down â no rolling, hold peak contraction 1-2 seconds" },
  ...
  // ââ ARMS âââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-curl-front.mp4", label: "Front View", focus: "Elbows stay pinned to sides, no swinging â strict curl" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-hammer-curl-front.mp4", label: "Front View", focus: "Palms face each other throughout â targets brachialis and brachioradialis" },
  ...
  },
  {
    ...
    angleViews: [
        ...
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-preacher-curl-side.mp4", label: "Side View", focus: "Upper arm flat on pad, don't lift elbows â isolates bicep peak" }
      ],
  },
  {
  ...
  },
  {
    ...
    angleViews: [
        ...
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Bodyweight-bodyweight-tricep-extension-side.mp4", label: "Side View", focus: "Elbows point to ceiling, only forearms move â upper arms stay vertical" }
      ],
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Bands-band-overhead-tricep-extension-front.mp4", label: "Front View", focus: "Elbows point forward, lower weight behind head to 90Â° then extend" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Bands-band-overhead-tricep-extension-side.mp4", label: "Side View", focus: "Elbows point forward, lower weight behind head to 90Â° then extend" }
      ],
  },
  {
    name: "Skull Crusher",
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Kettlebells-kettlebell-skull-crusher-front.mp4", label: "Front View", focus: "Elbows shoulder-width apart, don't flare â isolates long head" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-close-grip-bench-press-front.mp4", label: "Front View", focus: "Bar touches lower chest, elbows at 30Â° from torso" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-close-grip-bench-press-side.mp4", label: "Side View", focus: "Grip shoulder-width, elbows tuck close to body â targets triceps" }
      ],
  },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-front-squat-olympic-front.mp4", label: "Front View", focus: "Bar rests on front delts, fingertips support â elbows parallel to floor" },
  ...
  },
  {
    ...
    difficulty: "beginner",
    cue: "Feet shoulder-width on platform. Lower to 90Â°. Press up.",
    angleViews: [
        ...
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Machine-machine-leg-press-side.mp4", label: "Side View", focus: "Lower until knees at 90Â°, don't let lower back round off the pad" }
      ],
  },
  {
    name: "Leg Curl",
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-leg-curl-front.mp4", label: "Front View", focus: "Hips stay flat on pad, don't lift hips to assist" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Dumbbells-dumbbell-leg-curl-side.mp4", label: "Side View", focus: "Full range â from straight legs to heels touching glutes" }
      ],
  },
  {
    name: "Leg Extension",
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Machine-machine-leg-extension-front.mp4", label: "Front View", focus: "Back flat against pad, don't use momentum" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Machine-machine-leg-extension-side.mp4", label: "Side View", focus: "Full extension at top, squeeze quads, 1-second hold" }
      ],
  },
  {
    ...
    angleViews: [
        ...
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-romanian-deadlift-side.mp4", label: "Side View", focus: "Hinge at hips, bar slides down thighs, stop when hamstrings fully stretched" }
      ],
  },
  {
    name: "Hip Thrust",
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-hip-thrust-front.mp4", label: "Front View", focus: "Feet flat, knees at 90Â° at top, don't hyperextend lower back" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Machine-machine-standing-calf-raises-front.mp4", label: "Front View", focus: "Full range â deep stretch at bottom, high on toes at top" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Machine-machine-standing-calf-raises-side.mp4", label: "Side View", focus: "Full range â deep stretch at bottom, high on toes at top" }
      ],
  },
  {
    name: "Hack Squat",
    ...
    difficulty: "intermediate",
    cue: "Feet shoulder-width. Lower to 90Â°. Drive through heels.",
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Machine-machine-hack-squat-front.mp4", label: "Front View", focus: "Feet placement affects emphasis â narrow = more quads, wide = more inner thigh" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Machine-machine-hack-squat-side.mp4", label: "Side View", focus: "Back flat against pad, lower to 90Â° knee angle" }
      ],
  },
  {
    name: "Step Up",
  ...
  },
  {
    ...
    equipment: "Bodyweight or Dumbbells",
    difficulty: "beginner",
    cue: "Step back. Lower until both knees at 90Â°. Push forward to stand.",
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-reverse-lunge-front.mp4", label: "Front View", focus: "Torso upright, drive through front heel to return" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-reverse-lunge-side.mp4", label: "Side View", focus: "Step back far enough for 90Â° angles, front knee stays over ankle" }
      ],
  },
  {
    name: "Sumo Deadlift",
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-sumo-deadlift-front.mp4", label: "Front View", focus: "Wide stance, toes pointed out 45Â°, grip inside knees" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Barbell-barbell-sumo-deadlift-side.mp4", label: "Side View", focus: "More upright torso than conventional, hips closer to bar" }
      ],
  },
  {
  ...
  },
  {
    ...
    difficulty: "intermediate",
    cue: "Lean back 45Â°. Rotate torso side to side. Feet off floor.",
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Kettlebells-kettlebell-russian-twist-front.mp4", label: "Front View", focus: "Lean back 45Â°, rotate from thoracic spine not just arms" },
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-TRX-trx-ab-rollout-front.mp4", label: "Front View", focus: "Arms straight, core braced, roll back using abs not hip flexors" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-TRX-trx-ab-rollout-side.mp4", label: "Side View", focus: "Extend as far as you can control, don't let lower back sag" }
      ],
  },
  {
    name: "Bicycle Crunch",
  ...
  // ââ CARDIO / FULL BODY âââââââââââââââââââââââââââââââââââââââââââââââââââââ
  {
    name: "Burpee",
    key: "burpee",
  ...
  },
  {
    ...
    angleViews: [
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Plyometrics-box-jump-front.mp4", label: "Front View", focus: "Feet hip-width, land with full foot on box, stand tall at top" },
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Plyometrics-box-jump-side.mp4", label: "Side View", focus: "Arm swing for momentum, land softly with knees bent, step down don't jump" }
      ],
  },
  {
    ...
    angleViews: [
        ...
        { gifUrl: "https://media.musclewiki.com/media/uploads/videos/branded/male-Kettlebells-kettlebell-swing-side.mp4", label: "Side View", focus: "Hip hinge drives the swing, arms are passive â power from glutes" }
      ],
  },
  {
    name: "Battle Rope",
...
// ââ Lookup Maps ââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
...
export function getExerciseInfo(exerciseName: string): ExerciseInfo | undefined {
  ...
  // Partial match â find first exercise whose key is contained in the search
  for (const ex of EXERCISE_DB) {
