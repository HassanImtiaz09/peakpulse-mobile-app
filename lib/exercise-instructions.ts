...
const INSTRUCTIONS: Record<string, ExerciseInstruction> = {
  "bench press": {
    ...
    avoid: ["Flaring elbows to 90Â° â increases shoulder injury risk"],
  ...
  "push up": {
    ...
    avoid: ["Sagging hips or piking up â maintain a rigid plank"],
  ...
  "dumbbell fly": {
    steps: [
      ...
      "Maintain the same elbow angle throughout â don't straighten or bend further.",
      "Squeeze your chest to bring the dumbbells back together above your chest.",
    ],
    avoid: ["Going too heavy â this is an isolation movement"],
    breathing: "Inhale as you open your arms, exhale as you squeeze them together.",
  },
  "incline bench press": {
    steps: [
      "Set the bench to 30â45Â° incline. Grip the bar slightly wider than shoulder-width.",
    ...
    avoid: ["Setting the incline too steep (above 45Â°) â shifts work to shoulders"],
    breathing: "Inhale as you lower, exhale as you press.",
  },
  "incline dumbbell press": {
    steps: [
      "Set bench to 30â45Â°. Hold dumbbells at chest level with palms facing forward.",
  ...
  "chest dip": {
    ...
    avoid: ["Staying too upright â that shifts emphasis to triceps"],
    breathing: "Inhale on the descent, exhale on the press.",
  },
  "pull up": {
    steps: [
      ...
      "Lower yourself slowly to a full hang â control the descent.",
    ],
  ...
  "lat pulldown": {
    steps: [
      ...
      "Return the bar up slowly with control â don't let it yank your arms up.",
    ],
    avoid: ["Pulling the bar behind your neck â stresses the shoulders"],
  ...
  "bent over row": {
    ...
    avoid: ["Rounding your lower back â keep it neutral"],
  ...
  "seated cable row": {
    steps: [
      ...
      "Extend your arms forward slowly â don't let the weight stack pull you forward.",
    ],
  ...
  "deadlift": {
    steps: [
      ...
      "Reverse the movement to lower the bar â hinge at the hips first, then bend knees.",
    ],
  ...
  "t-bar row": {
    ...
    avoid: ["Standing too upright â maintain the hip hinge"],
    breathing: "Exhale as you row, inhale as you lower.",
  },
  "pendlay row": {
    steps: [
      ...
      "Lower the bar back to the floor with control â full stop between reps.",
    ],
    avoid: ["Lifting your torso during the row â stay parallel"],
  ...
  "overhead press": {
    ...
    avoid: ["Excessive back lean â keep your core braced"],
  ...
  "dumbbell shoulder press": {
    ...
    avoid: ["Flaring your rib cage â keep core tight"],
    breathing: "Exhale as you press, inhale as you lower.",
  },
  "lateral raise": {
    steps: [
      "Stand with dumbbells at your sides, slight bend in your elbows.",
      "Lead with your elbows, not your hands â imagine pouring water from a pitcher.",
      "Lower slowly â don't just drop the weight.",
    ],
  ...
  "front raise": {
    ...
    avoid: ["Swinging the weight â use strict form"],
    breathing: "Exhale as you raise, inhale as you lower.",
  },
  "face pull": {
    steps: [
    ...
    avoid: ["Using too much weight â this is a precision movement"],
  ...
  "arnold press": {
    ...
    avoid: ["Rushing the rotation â it should be smooth and continuous"],
  ...
  "upright row": {
    steps: [
      ...
      "Lead with your elbows â they should always be higher than your hands.",
      "Lower with control.",
    ],
    avoid: ["Pulling too high (above chest) â can cause shoulder impingement"],
    breathing: "Exhale as you pull up, inhale as you lower.",
  },
  "shrug": {
    steps: [
    ...
    avoid: ["Rolling your shoulders â just go straight up and down"],
  ...
  "barbell curl": {
    steps: [
      ...
      "Lower the bar slowly â resist gravity on the way down.",
    ],
  ...
  "preacher curl": {
    steps: [
      ...
      "Lower slowly to near-full extension â don't hyperextend at the bottom.",
    ],
  ...
  "tricep pushdown": {
    steps: [
      ...
      "Let the handle return slowly to the starting position â don't let your elbows drift forward.",
    ],
  ...
  "skull crusher": {
    steps: [
      ...
      "Keep your upper arms perpendicular to the floor â only your forearms move.",
  ...
  "close grip bench press": {
    ...
    avoid: ["Gripping too narrow â shoulder-width is sufficient"],
    breathing: "Inhale as you lower, exhale as you press.",
  },
  "squat": {
    steps: [
    ...
    avoid: ["Letting your knees cave inward â push them out over your toes"],
  ...
  "front squat": {
    ...
    avoid: ["Letting your elbows drop â the bar will roll forward"],
  ...
  "lunge": {
    ...
    avoid: ["Taking too short a step â your knee will go past your toes"],
  ...
  "leg extension": {
    steps: [
      ...
      "Lower slowly â don't let the weight stack slam down.",
    ],
    avoid: ["Using too much weight â this stresses the knee joint"],
    breathing: "Exhale as you extend, inhale as you lower.",
  },
  "romanian deadlift": {
    steps: [
    ...
    avoid: ["Rounding your lower back â keep it neutral throughout"],
  ...
  "glute bridge": {
    steps: [
      ...
      "Squeeze your glutes at the top â your body should form a straight line from shoulders to knees.",
  ...
  "calf raise": {
    ...
    avoid: ["Bouncing at the bottom â use a full, controlled range"],
  ...
  "step up": {
    ...
    avoid: ["Pushing off your back foot â let the front leg do the work"],
  ...
  "reverse lunge": {
    ...
    avoid: ["Leaning forward â keep your torso upright"],
    breathing: "Inhale as you step back, exhale as you return.",
  },
  "sumo deadlift": {
    steps: [
      "Stand with a wide stance, toes pointed out about 30â45Â°. Grip the bar inside your knees.",
  ...
  "stiff leg deadlift": {
    ...
    avoid: ["Rounding your back â maintain a neutral spine"],
  ...
  "plank": {
    steps: [
      ...
      "Engage your core, glutes, and quads â don't let your hips sag or pike.",
      "Hold the position for the prescribed duration.",
    ],
    avoid: ["Sagging hips â squeeze your glutes to maintain alignment"],
    breathing: "Breathe steadily throughout â don't hold your breath.",
  },
  "side plank": {
    steps: [
    ...
    breathing: "Breathe steadily â don't hold your breath.",
  },
  "crunch": {
    steps: [
      ...
      "Lower back down slowly â don't just drop.",
    ],
  ...
  "russian twist": {
    steps: [
      ...
      "Rotate to the other side â that's one rep.",
    ],
  ...
  "mountain climber": {
    steps: [
      ...
      "Keep your hips level â don't let them bounce up and down.",
      "Maintain a fast, controlled pace.",
    ],
    avoid: ["Piking your hips up high"],
    breathing: "Breathe rhythmically â exhale every 2â3 steps.",
  },
  "leg raise": {
    steps: [
      ...
      "Lower them slowly back down â stop just before they touch the floor.",
    ],
    avoid: ["Arching your lower back off the floor â press it down"],
    breathing: "Exhale as you raise, inhale as you lower.",
  },
  "hanging leg raise": {
    steps: [
      ...
      "Lower them slowly with control â no swinging.",
    ],
    avoid: ["Swinging your body â keep it controlled"],
  ...
  "ab wheel rollout": {
    ...
    avoid: ["Letting your hips sag â maintain a straight line"],
  ...
  "bicycle crunch": {
    steps: [
      ...
      "Switch sides in a pedaling motion â left elbow to right knee.",
  ...
  "cable woodchop": {
    ...
    avoid: ["Using your arms to pull â the power comes from your core rotation"],
  ...
  "jumping jack": {
    ...
    avoid: ["Landing flat-footed â stay on the balls of your feet"],
    breathing: "Breathe rhythmically â inhale on the out, exhale on the in.",
  },
  "box jump": {
    steps: [
  ...
  "kettlebell swing": {
    steps: [
      ...
      "Let the kettlebell swing back between your legs and repeat â it's a hip hinge, not a squat.",
    ],
    avoid: ["Squatting instead of hinging â push your hips back"],
  ...
  "battle rope": {
    ...
    avoid: ["Standing too upright â maintain a slight squat"],
    breathing: "Breathe rhythmically â don't hold your breath.",
  },
  "jump rope": {
    steps: [
      "Hold the rope handles at hip height with elbows close to your body.",
      "Jump just high enough to clear the rope â about 1 inch off the ground.",
      "Land softly on the balls of your feet.",
    ],
    avoid: ["Jumping too high â wastes energy"],
  ...
  "high knees": {
    ...
    avoid: ["Leaning back â stay tall or lean slightly forward"],
    breathing: "Breathe rhythmically â exhale every 2â3 steps.",
  },
  "sprint": {
    steps: [
    ...
    avoid: ["Heel striking â stay on your forefoot"],
    breathing: "Breathe naturally â don't try to control it during max effort.",
  },
};
