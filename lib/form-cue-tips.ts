...
const FORM_TIPS: Record<string, ExerciseFormTips> = {
  ...
  "high knees": {
    name: "High Knees",
    tips: [
      { text: "Drive knees to hip height", category: "form" },
      { text: "Pump arms, stay on balls of feet", category: "form" },
      { text: "Don't lean back", category: "mistake" },
      { text: "Breathe rhythmically with steps", category: "breathing" },
    ],
  },
  "sprint": {
    name: "Sprint",
