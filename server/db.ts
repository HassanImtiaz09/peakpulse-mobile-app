...
function getSamplePostsData() {
  return [
    ...
    { id: 8, userId: 0, userName: "Yuki N.", userAvatar: "ð¥ð¸", type: "challenge", caption: "Completed the 10K steps daily challenge for 21 days straight! My Fitbit sync with FytNova made tracking effortless. Starting the 7-day plank streak next ð¥ð¯", achievement: "21-Day Step Streak", likes: 189, createdAt: new Date(Date.now() - 144 * 3600000).toISOString() },
